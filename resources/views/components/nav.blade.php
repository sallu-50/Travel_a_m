    ...
    <nav class="bg-white shadow-md">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex space-x-6">
                ...
                <a href="#" class="text-black font-bold text-lg hover:text-gray-900">Register</a>
                <a href="#" class="text-black font-bold text-lg hover:text-gray-900">Service</a>
        ...
        <div id="mobile-menu" class="md:hidden px-4 pt-2 pb-4 hidden">
            ...
            <a href="#" class="block text-gray-600 hover:text-gray-900 py-2">Register</a>
            <a href="#service" class="block text-gray-600 hover:text-gray-900 py-2">Service</a>
